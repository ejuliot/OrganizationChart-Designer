 ...
 *******************************************************************************/
package org.obeonetwork.dsl.organizationchart.docgen.main;
...
/**
 * Entry point of the 'README_textile' generation module.
 *
 * @generated
 */
public class README_textile extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/organizationchart/docgen/main/README_textile";
     ...
     * @generated
     */
    public README_textile(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public README_textile(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                README_textile generator = new README_textile(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.sirius.tree.description.DescriptionPackage.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.sirius.tree.description.DescriptionPackage.eINSTANCE.getNsURI(), org.eclipse.sirius.tree.description.DescriptionPackage.eINSTANCE);
        }
