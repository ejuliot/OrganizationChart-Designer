...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>organizationchart</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OrganizationChartExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(OrganizationChartPackage.eNS_URI, 
			 OrganizationChartPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.orgchart"));
				Employee root = OrganizationChartFactory.eINSTANCE.createEmployee();
