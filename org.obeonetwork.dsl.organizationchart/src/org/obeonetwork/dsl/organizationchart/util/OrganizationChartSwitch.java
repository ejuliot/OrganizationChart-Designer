 ...
 * @generated
 */
public class OrganizationChartSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public OrganizationChartSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OrganizationChartPackage.EMPLOYEE: {
				Employee employee = (Employee)theEObject;
				T result = caseEmployee(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OrganizationChartPackage.ORGANIZATION: {
