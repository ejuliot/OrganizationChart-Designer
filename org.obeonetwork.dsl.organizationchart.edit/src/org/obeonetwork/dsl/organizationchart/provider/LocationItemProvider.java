...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.organizationchart.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrganizationChartPackage.Literals.LOCATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEmployeesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_employees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_employees_feature", "_UI_Location_type"),
				 OrganizationChartPackage.Literals.LOCATION__EMPLOYEES,
				 true,
				 false,
				 true,
				 null,
